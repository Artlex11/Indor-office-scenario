...
ASD_LOS = open("D:\\Всё моё\\Радиофак\\Практика\\РАДИО МОДУЛЬ\\ЗАДАНИЕ 1\\C++\\Graphics\\LSP_LOS\\PDF\\ASD_LOS_PDF.txt", 'r')

ASD_LOS = ASD_LOS.read()
numbers = list(map(float, ASD_LOS.split()))
